...
const char * C_dictionary::cpp_tail[] =
{
    ...
    "    fprintf( stdout, \"  wildcard_start = %s\\n\", wildcard_start ? \"true\" : \"false\" );",
    "    fprintf( stdout, \"  wildcard_end   = %s\\n\", wildcard_end   ? \"true\" : \"false\" );",
    "",
    ...
    "",
    "            bool found = ( ( word == roman ) ||",
    "                           ( wildcard_start && ( roman.find( word ) == 0 ) ) ||",
    "                           ( wildcard_end   && ( roman.find( word ) == ( roman.length() - word.length() ) ) ) );",
    "",
    "            if ( found )",
    "            {",
